...
class _$BannerModelImpl implements _BannerModel {
  const _$BannerModelImpl(
      ...
      @HiveField(3) this.subtitle,
      @HiveField(4) this.actionUrl});
  ...
  @override
  String toString() {
    return 'BannerModel(id: $id, imageUrl: $imageUrl, title: $title, subtitle: $subtitle, actionUrl: $actionUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, imageUrl, title, subtitle, actionUrl);
...
abstract class _BannerModel implements BannerModel {
  const factory _BannerModel(
      ...
      @HiveField(4) final String? actionUrl}) = _$BannerModelImpl;

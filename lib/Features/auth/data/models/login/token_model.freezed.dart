...
class _$TokenModelImpl implements _TokenModel {
  ...
  @override
  String toString() {
    return 'TokenModel(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, tokenType: $tokenType)';
  }
...
abstract class _TokenModel implements TokenModel {
  const factory _TokenModel(
      ...
      required final String tokenType}) = _$TokenModelImpl;
